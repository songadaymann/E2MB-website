...
function MintModal({ isOpen, onClose }) {
  ...
  const handleSliderChangeEnd = (value) => {
    ...
    setQuantity(closest)
    setSliderPosition(Math.log10(closest))
  }
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="6xl">
      <ModalOverlay />
      <ModalContent bg="black" border="2px solid white" maxW="920px">
        <ModalCloseButton />
        <ModalBody pb={8}>
          <Box textAlign="center" mb={10}>
            <Text fontSize={{ base: '2xl', md: '3xl' }} fontWeight="bold" textTransform="uppercase" letterSpacing="0.2em">
              every mint
            </Text>
            <Text fontSize={{ base: '2xl', md: '3xl' }} fontWeight="bold" textTransform="uppercase" letterSpacing="0.2em">
              extends the song
          ...
          <Box textAlign="center" pt={4} borderTop="1px solid" borderColor="gray.700">
